...
- (instancetype)initWithTableView:(UITableView *)tableView eventBus:(TDFEventBus *)eventBus
{
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (!cell) {
        ...
        if ([cell conformsToProtocol:@protocol(TDFEventBusProtocol)]) {
            [cell setValue:self.eventBus forKey:@"eventBus"];
        }
    }
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    if (self.mutableSections.count > section) {
        ...
        if ([headerView conformsToProtocol:@protocol(TDFEventBusProtocol)]) {
            [headerView setValue:self.eventBus forKey:@"eventBus"];
        }
...
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section
{
    if (self.mutableSections.count > section){
        ...
        if ([footerView conformsToProtocol:@protocol(TDFEventBusProtocol)]) {
            [footerView setValue:self.eventBus forKey:@"eventBus"];
        }
